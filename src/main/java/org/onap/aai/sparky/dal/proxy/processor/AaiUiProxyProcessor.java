...
public class AaiUiProxyProcessor {
  private static final Logger LOG = LoggerFactory.getInstance().getLogger(AaiUiProxyProcessor.class);
  ...
  private String getProxyPayloadAsString(final Exchange exchange) {
    ...
    try {
      ...
      LOG.error(AaiUiMsgs.ERROR_GENERIC, "Failed to extract payload for proxying.\n"
