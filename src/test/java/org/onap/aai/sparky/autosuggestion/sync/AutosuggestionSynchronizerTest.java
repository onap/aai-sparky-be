...
public class AutosuggestionSynchronizerTest {
  ...
  public void validateSmallSync() throws Exception {
    ...
    Mockito
        .when(aaiAdapter.repairSelfLink(Matchers.contains("8f87ab96-42bb-48c6-94c5-05f04bc8e271"),
            Mockito.anyString()))
        .thenReturn(
            "https://server.proxy:8443/aai/v11/network/generic-vnfs/generic-vnf/8f87ab96-42bb-48c6-94c5-05f04bc8e271");

    Mockito
        .when(aaiAdapter.repairSelfLink(Matchers.contains("61c4e837-9032-49d8-99ea-4a4a3c5d9905"),
            Mockito.anyString()))
        .thenReturn(
            "https://server.proxy:8443/aai/v11/network/generic-vnfs/generic-vnf/61c4e837-9032-49d8-99ea-4a4a3c5d9905");

    Mockito
        .when(
            aaiAdapter.repairSelfLink(Matchers.contains("generic-vnf-test19"), Mockito.anyString()))
        .thenReturn(
            "https://server.proxy:8443/aai/v11/network/generic-vnfs/generic-vnf/generic-vnf-test19");

    Mockito
        .when(aaiAdapter.queryActiveInventoryWithRetries(
            Matchers.contains("8f87ab96-42bb-48c6-94c5-05f04bc8e271"), Mockito.anyString(),
            Mockito.anyInt()))
        .thenReturn(new OperationResult(200, TestResourceLoader.getTestResourceDataJson(
            "/sync/aai/generic-vnf-8f87ab96-42bb-48c6-94c5-05f04bc8e271_full_depth.json")));

    Mockito
        .when(aaiAdapter.queryActiveInventoryWithRetries(
            Matchers.contains("61c4e837-9032-49d8-99ea-4a4a3c5d9905"), Mockito.anyString(),
            Mockito.anyInt()))
        .thenReturn(new OperationResult(200, TestResourceLoader.getTestResourceDataJson(
            "/sync/aai/generic-vnf-61c4e837-9032-49d8-99ea-4a4a3c5d9905_full_depth.json")));

    Mockito
        .when(aaiAdapter.queryActiveInventoryWithRetries(Matchers.contains("generic-vnf-test19"),
            Mockito.anyString(), Mockito.anyInt()))
        .thenReturn(new OperationResult(200, TestResourceLoader
            .getTestResourceDataJson("/sync/aai/generic-vnf-generic-vnf-test19_full_depth.json")));
