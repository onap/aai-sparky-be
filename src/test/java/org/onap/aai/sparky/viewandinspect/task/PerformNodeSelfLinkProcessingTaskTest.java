...
private Properties getTestProperties() {
 ...
 /*   ArgumentCaptor<String> linkCaptor = ArgumentCaptor.forClass(String.class);
    ...
    Mockito.when( mockTransaction.getSelfLink()).thenReturn("/aai/v10/network/logical-links/logical-link/alrga392ve2%20-%20xe-%2010%2F3%2F2.270%7Car4ga01pbg");
    ...
    assertEquals("https://aai-host:8443/aai/v10/network/logical-links/logical-link/alrga392ve2%20-%20xe-%2010%2F3%2F2.270%7Car4ga01pbg?p1=v1&p2=v2&p3=v3", linkCaptor.getValue());*/
...
/*    ArgumentCaptor<String> linkCaptor = ArgumentCaptor.forClass(String.class);
    ...
    assertEquals("https://aai-host:8443/aai/v10/network/logical-links/logical-link/alrga392ve2%20-%20xe-%2010%2F3%2F2.270%7Car4ga01pbg", linkCaptor.getValue());*/
  ...
  public void validateLinkEncoding_nullLink() {
   ...
   /* ArgumentCaptor<OperationResult> opResultCaptor = ArgumentCaptor.forClass(OperationResult.class);
    ...
    assertNotNull(opResultCaptor.getValue());
    assertEquals(500, opResultCaptor.getValue().getResultCode());*/
  ...
  public void validateLinkEncoding_withoutParameters_and_providerSuccess() {
    ...
    Mockito.when( mockTransaction.getProcessingNode() ).thenReturn(mockActiveInventoryNode);
    Mockito.when( mockTransaction.getSelfLink()).thenReturn("/aai/v10/network/logical-links/logical-link/alrga392ve2%20-%20xe-%2010%2F3%2F2.270%7Car4ga01pbg");
    Mockito.when( mockAaiProvider.queryActiveInventoryWithRetries(anyString(), anyString(), anyInt())).thenReturn(new OperationResult(200,"OK"));   
