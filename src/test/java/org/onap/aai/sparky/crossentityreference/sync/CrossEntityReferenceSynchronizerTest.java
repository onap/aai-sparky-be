...
public class CrossEntityReferenceSynchronizerTest {
  ...
  public void validateSmallSync() throws Exception {
    ...
    Mockito
        .when(aaiAdapter.repairSelfLink(Matchers.contains("uCPE-VMS"),
            Mockito.anyString()))
        .thenReturn(
            "https://server.proxy:8443/aai/v11/business/customers/customer/1710_2.3_09192017_DSG_9/service-subscriptions/service-subscription/uCPE-VMS");

    Mockito
        .when(aaiAdapter.repairSelfLink(Matchers.contains("TSBC"),
            Mockito.anyString()))
        .thenReturn(
            "https://server.proxy:8443/aai/v11/business/customers/customer/e433710f-9217-458d-a79d-1c7aff376d89/service-subscriptions/service-subscription/TSBC");

    Mockito
        .when(
            aaiAdapter.repairSelfLink(Matchers.contains("uXXX"), Mockito.anyString()))
        .thenReturn(
            "https://server.proxy:8443/aai/v11/business/customers/customer/DHV_20170525142406/service-subscriptions/service-subscription/uXXX");

    Mockito
        .when(aaiAdapter.queryActiveInventoryWithRetries(
            Matchers.contains("TSBC"), Mockito.anyString(),
            Mockito.anyInt()))
        .thenReturn(new OperationResult(200, TestResourceLoader.getTestResourceDataJson(
            "/sync/aai/service-subscription-TSBC.json")));

    Mockito
        .when(aaiAdapter.queryActiveInventoryWithRetries(
            Matchers.contains("uCPE-VMS"), Mockito.anyString(),
            Mockito.anyInt()))
        .thenReturn(new OperationResult(200, TestResourceLoader.getTestResourceDataJson(
            "/sync/aai/service-subscription-uCPE-VMS.json")));

    Mockito
        .when(aaiAdapter.queryActiveInventoryWithRetries(Matchers.contains("uXXX"),
            Mockito.anyString(), Mockito.anyInt()))
        .thenReturn(new OperationResult(200, TestResourceLoader
            .getTestResourceDataJson("/sync/aai/service-subscription-uXXX.json")));
    ...
    Mockito
        .when(aaiAdapter.getGenericQueryForSelfLink(Matchers.contains("service-instance"),
            Matchers.argThat(listContainsValue("6c15a01f-c2ba-4daf-b5c1-0e4ede633b36"))))
        .thenReturn(
            "https://server.proxy:8443/aai/v11/search/generic-query/6c15a01f-c2ba-4daf-b5c1-0e4ede633b36");

    Mockito
        .when(aaiAdapter.getGenericQueryForSelfLink(Matchers.contains("service-instance"),
            Matchers.argThat(listContainsValue("7dfef88f-fec0-421f-90d4-91eea35a5813"))))
        .thenReturn(
            "https://server.proxy:8443/aai/v11/search/generic-query/7dfef88f-fec0-421f-90d4-91eea35a5813");
    ...
    Mockito
        .when(aaiAdapter.getGenericQueryForSelfLink(Matchers.contains("service-instance"),
            Matchers.argThat(listContainsValue("7cb54908-f3fb-46b9-b547-d1e670ea95b2"))))
        .thenReturn(
            "https://server.proxy:8443/aai/v11/search/generic-query/7cb54908-f3fb-46b9-b547-d1e670ea95b2");
    ...
    Mockito
    .when(aaiAdapter.queryActiveInventoryWithRetries(
        Matchers.contains("generic-query/6c15a01f-c2ba-4daf-b5c1-0e4ede633b36"), Mockito.anyString(),
        Mockito.anyInt()))
    .thenReturn(new OperationResult(200, TestResourceLoader.getTestResourceDataJson(
        "/sync/aai/aai-traversal/generic-query/6c15a01f-c2ba-4daf-b5c1-0e4ede633b36.json")));

    Mockito
    .when(aaiAdapter.queryActiveInventoryWithRetries(
        Matchers.contains("generic-query/7dfef88f-fec0-421f-90d4-91eea35a5813"), Mockito.anyString(),
        Mockito.anyInt()))
    .thenReturn(new OperationResult(200, TestResourceLoader.getTestResourceDataJson(
        "/sync/aai/aai-traversal/generic-query/7dfef88f-fec0-421f-90d4-91eea35a5813.json")));
    ...
    Mockito
    .when(aaiAdapter.queryActiveInventoryWithRetries(
        Matchers.contains("generic-query/7cb54908-f3fb-46b9-b547-d1e670ea95b2"), Mockito.anyString(),
        Mockito.anyInt()))
    .thenReturn(new OperationResult(200, TestResourceLoader.getTestResourceDataJson(
        "/sync/aai/aai-traversal/generic-query/7cb54908-f3fb-46b9-b547-d1e670ea95b2.json")));
    ...
    Mockito
    .when(aaiAdapter.queryActiveInventoryWithRetries(
        Matchers.contains("6c15a01f-c2ba-4daf-b5c1-0e4ede633b36"), Mockito.anyString(),
        Mockito.anyInt()))
    .thenReturn(new OperationResult(200, TestResourceLoader.getTestResourceDataJson(
        "/sync/aai/aai-resources/service-instance/6c15a01f-c2ba-4daf-b5c1-0e4ede633b36.json")));

    Mockito
    .when(aaiAdapter.queryActiveInventoryWithRetries(
        Matchers.contains("7dfef88f-fec0-421f-90d4-91eea35a5813"), Mockito.anyString(),
        Mockito.anyInt()))
    .thenReturn(new OperationResult(200, TestResourceLoader.getTestResourceDataJson(
        "/sync/aai/aai-resources/service-instance/7dfef88f-fec0-421f-90d4-91eea35a5813.json")));
    ...
    Mockito
    .when(aaiAdapter.queryActiveInventoryWithRetries(
        Matchers.contains("7cb54908-f3fb-46b9-b547-d1e670ea95b2"), Mockito.anyString(),
        Mockito.anyInt()))
    .thenReturn(new OperationResult(200, TestResourceLoader.getTestResourceDataJson(
        "/sync/aai/aai-resources/service-instance/7cb54908-f3fb-46b9-b547-d1e670ea95b2.json")));
