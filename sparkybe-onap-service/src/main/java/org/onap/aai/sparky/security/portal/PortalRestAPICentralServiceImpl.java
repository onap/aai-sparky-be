...
public class PortalRestAPICentralServiceImpl implements IPortalRestCentralService,IPortalRestAPIService {
  ...
  //Do we really need to save the users? Can this method be  just empty and not throw an exception?
  ...
  public EcompUser getUser(String loginId) throws PortalAPIException {
    ...
    try {
        responseString = RestWebServiceClient.getInstance().getPortalContent(API_REDIRECT_VERSION + "/user/" + loginId, null,
  ...
  public List<EcompUser> getUsers() throws PortalAPIException {
    ...
    String responseString = null;
    try {
        responseString = RestWebServiceClient.getInstance().getPortalContent(API_REDIRECT_VERSION + "/users", null, null, null,
  ...
  public List<EcompRole> getAvailableRoles(String requestedLoginId) throws PortalAPIException {
    ...
    String responseString = null;
    try {
        responseString = RestWebServiceClient.getInstance().getPortalContent(API_REDIRECT_VERSION + "/roles", requestedLoginId,
                null, null, getCredentials().get("username"), getCredentials().get("password"), true);
        LOG.debug("responseString is: " + responseString);
